export default {
  ...
  created() {
    ...
    for(let i in this.$route.params.projectData){
      this.projectColl.push({
      name: this.$route.params.projectData[i].name,
      project_id:this.$route.params.projectData[i].project_id
      })
    }
